# Script:  price_analysis.R
# Purpose: Summary stats, price histograms, scatter plots, OLS regressions (tasks 2-5)
# Input:   datasets/airbnb/processed/listings_{region}_cleaned.rds
# Output:  week_1/analysis/output/tables/, week_1/analysis/output/figures/

library(tidyverse)
library(psych)
source(here::here("datasets", "airbnb", "_config_airbnb.R"))

listings_cleaned <- read_rds(
...
listings_acc2 <- listings_cleaned %>%
...
listings_acc6 <- listings_cleaned %>%

...
scores_gemini     <- read_csv(file.path(SCORES_DIR, paste0(tolower(REGION), "_scores_gemini.csv")))
scores_perplexity <- read_csv(file.path(SCORES_DIR, paste0(tolower(REGION), "_scores_perplexity.csv")))
...
saveRDS(listings_final,
        file.path(DATA_PROC, paste0("listings_", tolower(REGION), "_final.rds")))
